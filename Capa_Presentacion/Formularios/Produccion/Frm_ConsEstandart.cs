...
{
    public partial class Frm_ConsEstandart : Form
    {
        ...
        private void Img_Producto_Click(object sender, EventArgs e)
        {

        }

        public Frm_ConsEstandart()
        {
            InitializeComponent();
        }

        private void Frm_ConsEstandart_Load(object sender, EventArgs e)
        {
            Cargar_Combos();
