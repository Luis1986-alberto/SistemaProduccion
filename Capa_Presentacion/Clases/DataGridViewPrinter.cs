    ...
    public class DataGridViewPrinter
    {
        ...
        private void DrawHeader(Graphics g)
        {
            ...
            if (IsWithPaging)
            {
                ...
                string PageString = DateTime.Now.ToString("G") + "Page " + PageNumber.ToString();
                // string Fecha = "Fecha" + DateTime.Now.ToString("G");
                ...
                //Posicionando la fecha

                //RectangleF PageFechaRectangle = new RectangleF((float)LeftMargin, CurrentY, (float)PageWidth - (float)RightMargin - (float)LeftMargin, g.MeasureString(Fecha, PageStringFont).Height);

                //g.DrawString(Fecha, PageStringFont, new SolidBrush(Color.Black), PageStringRectangle, PageStringFormat);

                // CurrentY += g.MeasureString(Fecha, PageStringFont).Height;
