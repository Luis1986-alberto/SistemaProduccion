...
{
    public class PR_xProgramaSelladoInd
    {
        public decimal IdProgSelladoInd { get; set; }
        ...
        public Nullable<byte> IdEmpresa_Sel { get; set; }
        public Nullable<decimal> Numero_Servicio_Sel { get; set; }
