...
{
    public class PR_xProgramaCorteInd
    {
        public decimal IdProgCorteInd { get; set; }
        ...
        public Nullable<byte> IdEmpresa_Cor { get; set; }
        public string Numero_Servicio_Cor { get; set; }
