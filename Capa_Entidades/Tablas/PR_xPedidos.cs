...
namespace Capa_Entidades.Tablas
{
    public class PR_xPedidos
    {
        ...
        public decimal Porcentaje_Merma { get; set; }
        public decimal Total_Kilos { get; set; }
        public byte IdSeVendePor { get; set; }
        public decimal Cantidad_Millares { get; set; }
        public decimal Precio_Kilo { get; set; }
        public decimal Precio_Millar { get; set; }
        public decimal Reajuste_Precio_Kilo { get; set; }
        public decimal Reajuste_Precio_Millar { get; set; }
        public string Flag_MasIGV { get; set; }
        ...
        //public decimal getCantidad_Kilos()
        //{ return Cantidad_Kilos; }

        //public void setCantidad_Kilos(decimal cantidadkilos)
        //{
        //    if (cantidadkilos == 0) this.Cantidad_Kilos = cantidadkilos;
        //    else MessageBox.Show("Ingrese Cantidad de Kilos");
        //}

        public PR_xPedidos(int idNumeroPedido, string numero_Pedido, string numero_Orden_Compra, Int32 idEstandar, byte? idEmpresa, 
            ...
            decimal precio_Kilo, decimal precio_Millar, decimal reajuste_Precio_Kilo, decimal reajuste_Precio_Millar, string flag_MasIGV, 
            string flag_Incluido_Gastos, string flag_DestararBobinaExtruida, string flag_DestararBobinaImpresa, string flag_Comision, 
            string nota_Pedido, string flag_NuevoRepetidoHistorico, string flag_NoExisteEspecificacion, string idUsuario, string pedido_General,
            byte idTipoVenta,  string flag_DestararBobinaLaminado, string flag_DestararBobinaCorte, decimal metros, DateTime? fecha_Orden_Compra,
            string observacion_CD, string idUsuario_CD, string idUsuario_PC_CD, DateTime? fecha_Servidor_CD, byte? idCondicionProceso, short? idTrabajador)
        {
